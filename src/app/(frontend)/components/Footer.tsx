    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-[1920px] mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Footer Column 1 */}
          <div>
            <h3 className="text-xl font-semibold mb-4">Hongsen Industrial</h3>
            <p className="mb-4 text-gray-400">Professional manufacturer of industrial air motors, air winches, air hoists, and air mixers.</p>
          ...
          <div>
            ...
            <address className="not-italic text-gray-400">
              <p className="mb-2">123 Industrial Avenue</p>
              <p className="mb-2">Shanghai, China 200000</p>
              <p className="mb-2">Email: info@hongsen.com</p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-center text-gray-400 text-sm">
            © {new Date().getFullYear()} Hongsen Industrial Co., Ltd. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
